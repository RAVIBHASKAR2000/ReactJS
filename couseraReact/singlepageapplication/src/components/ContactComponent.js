                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-md-9">
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <Col md={10}>
                                <Input type="textarea" id="message" name="message"  value={this.state.message} rows="12" 
                                onChange={this.handleInputChange} /> 
                            </Col>
                        ...
                        <Button type="submit" color="primary" onChange={this.handleInputChange}>Send Feedback</Button> 
                        </Col>
                        </FormGroup>
                        </Form>
                    </div>
